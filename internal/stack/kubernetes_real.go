...
func NewRealKubernetesClient(cfg config.StackConfig) (*RealKubernetesClient, error) {
...
func (c *RealKubernetesClient) CreatePodAndService(ctx context.Context, req ProvisionRequest) (ProvisionResult, error) {
...
func (c *RealKubernetesClient) DeletePodAndService(ctx context.Context, namespace, podID, serviceName string) error {
	if serviceName != "" {
...
func (c *RealKubernetesClient) GetPodStatus(ctx context.Context, namespace, podID string) (Status, string, error) {
...
func (c *RealKubernetesClient) ListPods(ctx context.Context, namespace string) ([]string, error) {
...
func (c *RealKubernetesClient) ListServices(ctx context.Context, namespace string) ([]string, error) {
...
func (c *RealKubernetesClient) NodeExists(ctx context.Context, nodeID string) (bool, error) {
	if nodeID == "" {
		return false, nil
	}
...
func (c *RealKubernetesClient) waitUntilSchedulable(ctx context.Context, namespace, podName string) error {
